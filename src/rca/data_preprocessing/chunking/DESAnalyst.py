...
from rca.data_preprocessing.timestamps_incidents import TextSniffer
...
def line_lens_analysis_api(dest_root, ts_mark, time_start, time_end):
    ...
    line_lengths = chunker.line_lengths(winsel_dest)
...
def api(root, dest
    ...
    chunk_sizes, after_dedu = chunker.chunk_dataset(src=winsel_dest
